...
const constants = Object.freeze({
	...
	name: 'weibo', // Something unique to your OAuth provider in lowercase, like "github", or "nodebb"
	oauth: {
		requestTokenURL: '',
		accessTokenURL: '',
	...
	userRoute: 'https://api.weibo.com/2/users/show.json', // This is the address to your app's "user profile" API endpoint (expects JSON)
});
